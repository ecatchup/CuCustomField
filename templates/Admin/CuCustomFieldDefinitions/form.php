...
$currentModelName = $this->getRequest()->getAttribute('params')['models']['CuCustomFieldDefinition']['className'];
...
<?php if ($this->getRequest()->action == 'admin_add'): ?>
	<?php echo $this->BcForm->create('CuCustomFieldDefinition', ['url' => ['action' => 'add', $configId]]) ?>
<?php else: ?>
	<?php echo $this->BcForm->create('CuCustomFieldDefinition', ['url' => ['action' => 'edit', $configId, $this->getRequest()->getData('CuCustomFieldDefinition.id')]]) ?>
<?php endif ?>
...
<?php if ($this->getRequest()->action == 'admin_edit'): ?>
		<tr>
