...
<tr<?php echo $class ?>>
	...
	<?php $this->BcBaser->link($this->BcBaser->getImg('admin/icn_tool_manage.png', array('alt' => '管理', 'class' => 'btn')),
	...
	<?php if ($this->request->params['pass']): ?>
		<?php if ($count != 1 || !isset($datas)): ?>
			<?php $this->BcBaser->link('<i class="fa fa-arrow-up fa-2x" style="vertical-align: bottom;margin-left: 2px;"></i>',
		...
		<?php if (!isset($datas) || count($datas) != $count): ?>
			<?php $this->BcBaser->link('<i class="fa fa-arrow-down fa-2x" style="vertical-align: bottom;margin-left: 2px;"></i>',
