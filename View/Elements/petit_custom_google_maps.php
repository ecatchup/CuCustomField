...
<?php if ($this->BcBaser->siteConfig['google_maps_api_key']): ?>
	<?php if ($google_maps_latitude && $google_maps_longtude && $google_maps_zoom): ?>
		<div class="petit-google-maps" style="width: <?php echo h($googleMapsWidth) ?>; height:<?php echo h($googleMapsHeight) ?>;" data-latitude="<?php echo h($google_maps_latitude) ?>" data-longtude="<?php echo h($google_maps_longtude) ?>" data-zoom="<?php echo h($google_maps_zoom) ?>" data-zoom="<?php echo h($google_maps_text) ?>" data-text="<?php echo h($text) ?>"></div>
